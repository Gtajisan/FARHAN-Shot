...
---------------------------------------------------------------------------------------                                                                     
 ...
 one line command : sudo python FARHAN-Shot/FARHAN-Shot.py -i wlan0 --iface-down -K
...
def usage():
    return """
FARHAN-ShotPin 0.0.2 (c) 2017 rofl0r, modded by drygdryg
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        description='FARHAN-ShotPin 0.0.2 (c) 2017 rofl0r, modded by drygdryg',
